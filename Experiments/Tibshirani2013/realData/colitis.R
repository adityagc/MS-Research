### This is the code used to analyze the Colitis dataset in the manuscript
...
training.ind <- sample(1:nrow(X), 50) #30
...
lambdas.gl <- exp(seq(from = log(lambda.max.group), to = log(lambda.max.group*0.01), length.out = 100))
